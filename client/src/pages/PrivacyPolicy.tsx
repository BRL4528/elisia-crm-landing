          ...
          <CardContent className="pt-6">
            <ScrollArea className="h-[800px] pr-4">
              <div className="space-y-6 text-muted-foreground">
                ...
                <section>
                  <h2 className="text-xl font-semibold text-foreground mb-3">2 – SOBRE OS DADOS COLETADOS</h2>
                  
                  <h3 className="text-lg font-medium text-foreground mb-2">2.1 – DADOS PESSOAIS FORNECIDOS PELO USUÁRIO</h3>
                  <p>
                    Os dados pessoais podem ser coletados diretamente por simples disponibilização a um funcionário do(a) ZMG SOLUTIONS LTDA quando do preenchimento de cadastro ou acordos comerciais, bem, como mediante a interação em nossas plataformas.
                  </p>

                  <h3 className="text-lg font-medium text-foreground mt-4 mb-2">2.2 – QUAIS DADOS SÃO COLETADOS</h3>
                  <p>
                    O(a) ZMG SOLUTIONS LTDA coleta informações de modo automático em suas plataformas de interação com o Usuário, tais como: Nome Completo, CPF, E-mail e Telefone; estado civil, local de nascimento, documentos de identificação e CPF, nome da mãe e pai, informações sobre cônjuge, endereço, dados bancários, dados de contrato; dados bancário; informações de renda; endereço de IP e Cookies.
                  </p>
                </section>

                <section>
                  <h2 className="text-xl font-semibold text-foreground mb-3">3 – PARA QUE FINALIDADES UTILIZAMOS OS DADOS PESSOAIS DO USUÁRIO E VISITANTE?</h2>
                  <p className="mb-4">
                    Os dados pessoais tratados pelo(a) ZMG SOLUTIONS LTDA têm como principais finalidades a possibilidade do Usuário conhecer a oferta de produtos e serviços ZMG SOLUTIONS LTDA, o fornecimento de informações via formulário de contato ou pelo corretor online, identificar os Usuários que navegam no site e manter os dados de Usuários atualizados.
                  </p>
                  
                  <p className="mb-2">Os dados poderão ser utilizados:</p>
                ...
                <section>
                  <h2 className="text-xl font-semibold text-foreground mb-3">4 – COM QUEM OS DADOS SÃO COMPARTILHADOS</h2>
                  <ul className="list-disc pl-6 space-y-2">
                ...
                <section>
                  <h2 className="text-xl font-semibold text-foreground mb-3">5 – POR QUANTO TEMPO OS DADOS PESSOAIS FICAM ARMAZENADOS?</h2>
                  <p>
                ...
                <section>
                  <h2 className="text-xl font-semibold text-foreground mb-3">6 – SEGURANÇA DOS DADOS PESSOAIS ARMAZENADOS</h2>
                  <p>
                    O(a) ZMG SOLUTIONS LTDA se compromete a aplicar as medidas técnicas e organizativas aptas a proteger os dados pessoais de acessos não autorizados e de situações de destruição, perda, alteração, comunicação ou difusão de tais dados.
                  </p>
                  <p className="mt-2">
                    O(a) ZMG SOLUTIONS LTDA não se exime de responsabilidade por culpa exclusiva de terceiro, como em caso de ataque de hackers ou crackers, ou culpa exclusiva do usuário, como no caso em que ele mesmo transfere seus dados a terceiros, comprometendo-se a comunicar o usuário em caso de alguma violação de segurança dos seus dados pessoais.
                  </p>
                  <p className="mt-2">
                ...
                <section>
                  <h2 className="text-xl font-semibold text-foreground mb-3">7 – COOKIES OU DADOS DE NAVEGAÇÃO</h2>
                  <p>
                    Os cookies referem-se a arquivos de texto enviados pela plataforma ao computador do usuário e visitante e que nele ficam armazenados, com informações relacionadas à navegação no site.
                  </p>
                  <p className="mt-2">
                    Tais informações são relacionadas aos dados de acesso como local e horário de acesso e são armazenadas pelo navegador do usuário e visitante para que o servidor da plataforma possa lê-las posteriormente a fim de personalizar os serviços da plataforma.
                  </p>
                  <p className="mt-2">
                ...
                <section>
                  <h2 className="text-xl font-semibold text-foreground mb-3">8 – CONSENTIMENTO</h2>
                  <p>
                  ...
                  <p className="mt-2">
                    O usuário tem direito de retirar o seu consentimento a qualquer tempo, para tanto deve entrar em contato com nosso escritório.
                  </p>
                </section>

                <section>
                  <h2 className="text-xl font-semibold text-foreground mb-3">9 – ALTERAÇÕES PARA ESSA POLÍTICA DE PRIVACIDADE</h2>
                  <p>
                ...
                <section>
                  <h2 className="text-xl font-semibold text-foreground mb-3">10 – JURISDIÇÃO PARA RESOLUÇÃO DE CONFLITOS</h2>
                  <p>
